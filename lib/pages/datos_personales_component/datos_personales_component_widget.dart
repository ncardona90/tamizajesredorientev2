...
/// Create a component Crea un componente llamado `DatosPersonalesForm` que
/// contenga los siguientes campos, con etiquetas en español.
///
/// Usa un `Column` con espaciado interno (`padding: 16`). Cada campo debe ser
/// responsivo y tener validaciones básicas.
///
/// - TextField: Nombres (obligatorio)
/// - TextField: Apellidos (obligatorio)
/// - DropDown: Tipo de Documento (C.C., Pasaporte, Otro) (obligatorio)
/// - TextField: Número de Documento (solo números, obligatorio)
/// - TextField: Nacionalidad (obligatorio)
/// - DatePicker: Fecha de Nacimiento (obligatorio)
/// - TextField: Edad (solo números, obligatorio)
/// - DropDown: Género (Masculino, Femenino, Otro) (obligatorio)
/// - TextField: Dirección de Residencia (obligatorio)
/// - TextField: Barrio / Corregimiento / Vereda (obligatorio)
/// - TextField: Comuna (solo números)
/// - TextField: Teléfono de Contacto (solo teléfono, obligatorio)
/// - TextField: Correo Electrónico (solo email, obligatorio)
class DatosPersonalesComponentWidget extends StatefulWidget {
  const DatosPersonalesComponentWidget({
    super.key,
    this.nombres,
    this.apellidos,
    this.tipodoc,
  ...
  @override
  State<DatosPersonalesComponentWidget> createState() =>
      _DatosPersonalesComponentWidgetState();
}

class _DatosPersonalesComponentWidgetState
    extends State<DatosPersonalesComponentWidget> {
  late DatosPersonalesComponentModel _model;
  ...
  void initState() {
    ...
    _model.edadTextFieldTextController ??= TextEditingController(
        text: functions.calcularEdad(_model.datePicked!).toString());
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.nombresTextFieldTextController,
                                    focusNode: _model.nombresTextFieldFocusNode,
                                    autofocus: false,
                                    textCapitalization:
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FlutterFlowDropDown<String>(
                                  ...
                                  options: List<String>.from(Tipodoc.values
                                      .map((e) => e.name)
                                      .toList()),
                                  optionLabels: Tipodoc.values
                                      .map((e) => e)
                                      .toList()
                                      .map((e) => e.name)
                                      .toList(),
                                  onChanged: (val) => safeSetState(() =>
                                      _model.tipoDocumentoDropDownValue = val),
                                  width: double.infinity,
                                  height: 50.0,
                                  ...
                                  hintText: 'Seleccione tipo de documento',
                                  fillColor: FlutterFlowTheme.of(context)
                                      .secondaryBackground,
                                  elevation: 0.0,
                                  borderColor:
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller: _model
                                        .numeroDocumentoTextFieldTextController,
                                    focusNode: _model
                                        .numeroDocumentoTextFieldFocusNode,
                                    autofocus: false,
                                    textInputAction: TextInputAction.next,
                                    obscureText: false,
                                    decoration: InputDecoration(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller: _model
                                        .nacionalidadColumnTextFieldTextController,
                                    focusNode: _model
                                        .nacionalidadColumnTextFieldFocusNode,
                                    autofocus: false,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    textInputAction: TextInputAction.next,
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.edadTextFieldTextController,
                                    focusNode: _model.edadTextFieldFocusNode,
                                    autofocus: false,
                                    textInputAction: TextInputAction.next,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                    ...
                                    keyboardType: TextInputType.number,
                                    validator: _model
                                        .edadTextFieldTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                              ...
                              Padding(
                                ...
                                child: FlutterFlowDropDown<String>(
                                  ...
                                  onChanged: (val) => safeSetState(() => _model
                                      .gemneroBiologicoDropDownValue = val),
                                  width: double.infinity,
                                  height: 50.0,
                                  textStyle: FlutterFlowTheme.of(context)
                                      .bodyMedium
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller: _model
                                        .direccionResidenciaTextFieldTextController,
                                    focusNode: _model
                                        .direccionResidenciaTextFieldFocusNode,
                                    autofocus: false,
                                    textInputAction: TextInputAction.next,
                                    obscureText: false,
                                    decoration: InputDecoration(
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.barrioTextFieldTextController,
                                    focusNode: _model.barrioTextFieldFocusNode,
                                    autofocus: false,
                                    textInputAction: TextInputAction.next,
                                    obscureText: false,
                                    decoration: InputDecoration(
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.comunaTextFieldTextController,
                                    focusNode: _model.comunaTextFieldFocusNode,
                                    autofocus: false,
                                    textInputAction: TextInputAction.next,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.telefonoTextFieldTextController,
                                    focusNode:
                                        _model.telefonoTextFieldFocusNode,
                                    autofocus: false,
                                    textInputAction: TextInputAction.next,
                                    obscureText: false,
                                    decoration: InputDecoration(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller: _model
                                        .correoElectronicoTextFieldTextController,
                                    focusNode: _model
                                        .correoElectronicoTextFieldFocusNode,
                                    autofocus: false,
